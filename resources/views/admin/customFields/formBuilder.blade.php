    ...
    <div class="form-group mb-3 {{ $customField->width }}">
        ...
        <div class="form-icon-user">
            <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name"
                name="name" placeholder="{{ __($customField->placeholder) }}" required="" value="{{old('name')}}">
    ...
    <div class="form-group mb-3 {{ $customField->width }}">
        ...
        <div class="form-icon-user">
            <input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="email"
                name="email" placeholder="{{ __($customField->placeholder) }}" required="" value="{{old('email')}}">
            <div class="invalid-feedback d-block">
                {{ $errors->first('email') }}
            </div>
        </div>
...
<div class="col-lg-6">
    <div class="form-group mb-3 {{ $customField->width }}">
        ...
        <div class="form-icon-user">
            <input type="text" class="form-control {{ $errors->has('subject') ? ' is-invalid' : '' }}" id="subject"
                name="subject" placeholder="{{ __($customField->placeholder) }}" required="" value="{{old('subject')}}">
            <div class="invalid-feedback d-block">
...
<div class="col-lg-12">
    <div class="form-group mb-3 {{ $customField->width }}">
        ...
        <textarea name="description"
            class="form-control ckdescription {{ $errors->has('description') ? ' is-invalid' : '' }}"
