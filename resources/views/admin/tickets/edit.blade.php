                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <small>
                            <span  class="text-right">
                                {{ __('Status') }} : <span style="font-size:13px"  class="badge rounded @if ($ticket->status == 'In Progress') badge bg-warning  @elseif($ticket->status == 'On Hold') badge bg-danger @else badge bg-success @endif">{{ __($ticket->status) }}</span>
                            </span>
