...
<?php $__env->startSection('content'); ?>
    ...
    <div class="auth-wrapper auth-v1">
        ...
        <div class="auth-content">
            ...
            <nav  class="navbar navbar-expand-md navbar-light default light_background_color" style="background: #fff !important;flex-wrap: inherit !important;">
                ...
                <div class="col-xl-12 text-center">
                    ...
                    <div class="card">
                        <div class="card-body w-100">
                            <div class="">
                                <h4 style="color:#d70926 !important" class="text-primary mb-3"><?php echo e(__('Create Ticket')); ?></h4>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-center">
                                        <div class="d-block ">
                                            ...
                                            <button style="background-color:#d70926 !important; border-color: #d70926; !important" class="btn btn-primary btn-block mt-2">                                            
                                                <?php echo e(__('Create Ticket')); ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fabuxrfq/support.fasttechnologies.pk/resources/views/home.blade.php ENDPATH**/ ?>