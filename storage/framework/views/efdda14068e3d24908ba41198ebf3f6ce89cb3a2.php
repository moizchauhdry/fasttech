...
<div class="col-lg-6">
    <div class="form-group mb-3 <?php echo e($customField->width); ?>">
        ...
        <div class="form-icon-user">
            <input type="text" class="form-control <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" id="name"
                name="name" placeholder="<?php echo e(__($customField->placeholder)); ?>" required="" value="<?php echo e(old('name')); ?>">
...
<div class="col-lg-6">
    <div class="form-group mb-3 <?php echo e($customField->width); ?>">
        ...
        <div class="form-icon-user">
            <input type="email" class="form-control <?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" id="email"
                name="email" placeholder="<?php echo e(__($customField->placeholder)); ?>" required="" value="<?php echo e(old('email')); ?>">
            <div class="invalid-feedback d-block">
...
<div class="col-lg-6">
    <div class="form-group mb-3 <?php echo e($customField->width); ?>">
        ...
        <select class="form-select" id="category" name="category"
            data-placeholder="<?php echo e(__($customField->placeholder)); ?>">
            <option value=""><?php echo e(__($customField->placeholder)); ?></option>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($category->id); ?>" <?php if(old('category')==$category->id): ?> selected <?php endif; ?>><?php echo e($category->name); ?>
...
<div class="col-lg-6">
    <div class="form-group mb-3 <?php echo e($customField->width); ?>">
        ...
        <div class="form-icon-user">
            <input type="text" class="form-control <?php echo e($errors->has('subject') ? ' is-invalid' : ''); ?>" id="subject"
                name="subject" placeholder="<?php echo e(__($customField->placeholder)); ?>" required="" value="<?php echo e(old('subject')); ?>">
            <div class="invalid-feedback d-block">
...
<div class="col-lg-12">
    <div class="form-group mb-3 <?php echo e($customField->width); ?>">
        ...
        <textarea name="description"
            class="form-control ckdescription <?php echo e($errors->has('description') ? ' is-invalid' : ''); ?>"
            placeholder="<?php echo e(__($customField->placeholder)); ?>"><?php echo e(old('description')); ?></textarea>
    ...
    <div class="form-group mb-3 <?php echo e($customField->width); ?>">
        ...
        <div class="choose-file form-group">
            <label for="file" class="form-label">
                ...
                <input type="file" class="form-control <?php echo e($errors->has('attachments.') ? 'is-invalid' : ''); ?>"
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH C:\laragon\www\fasttech\resources\views/admin/customFields/formBuilder.blade.php ENDPATH**/ ?>